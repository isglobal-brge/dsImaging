...
# Weights go to /var/lib/dsimaging/models/<provider>/<model_or_task>/
# This is infrastructure, not patient data -- shared across all users.

#' Get the models directory
#' @keywords internal
.models_dir <- function() {
  dir <- .imaging_analysis_option("models_dir",
...
#' After install, the model is available for all dsImaging jobs.
#'
